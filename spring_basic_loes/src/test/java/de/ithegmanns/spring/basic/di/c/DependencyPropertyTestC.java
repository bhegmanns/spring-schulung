 ...
 * @author B. Hegmanns
 */
public class DependencyPropertyTestC {
	private static Logger LOG = Logger.getLogger(DependencyPropertyTestC.class.getName());
	...
	public static void vorbereitung() throws IOException{
		...
		applicationContext = new ClassPathXmlApplicationContext("de/ithegmanns/spring/basic/di/c/beans.xml");
		
//		Properties properties = PropertiesLoaderUtils.loadAllProperties("classpath:beans.properties");
//		LOG.info("package.suffix: " + properties.getProperty("package.suffix"));
//		Assert.assertNotNull("Package suffix fehlet: " + properties, properties.getProperty("package.suffx"));
...
//		applicationContext.refresh();
	...
	@Test
	public void nummerAnlegen(){
		Nummer nummer = applicationContext.getBean("nummer", Nummer.class);
		Assert.assertEquals("Habe 25 als wert erwartet, jedoch erhalten: " + nummer.getWert(), 25, nummer.getWert());
	}
