 ...
 * @author B. Hegmanns
 */
public class DependencyPropertyTestB {
	private static Logger LOG = Logger.getLogger(DependencyPropertyTestB.class.getName());
	...
	public static void vorbereitung(){
		applicationContext = new ClassPathXmlApplicationContext("de/ithegmanns/spring/basic/di/b/beans-properties.xml");
